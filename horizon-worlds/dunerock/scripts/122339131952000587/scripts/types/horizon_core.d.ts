...
export declare const CodeBlockEvents: {
     ...
     *
     * @deprecated World Broadcast is being shut down and the `OnWorldBroadcastCameraJoined` event will no longer fire. World Broadcast implementations can be removed from your worlds.
     */
